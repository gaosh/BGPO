...
class VPG(RLAlgorithm):
    ...
    def train_once(self, itr, paths):
        ...
        if self.flat_values:
            ...
            self._train_no_flat(obs, actions, rewards, returns, valids, baselines)
        ...
        mean_return = np.mean(undiscounted_returns)

        file = open(self.log_dir, 'a')
        file.write("%.4f\n" % (mean_return))
        file.close()
    ...
    def _train_no_flat(self, obs, actions, rewards, returns, valids, baselines):
